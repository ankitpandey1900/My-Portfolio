...
const buttonVariants = cva(
  'group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none active:translate-y-[1px] disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*="size-"])]:size-4 font-sans tracking-wide',
  {
    variants: {
      variant: {
        primary:
          'bg-primary text-primary-foreground shadow-glow-teal hover:bg-primary/95 hover:shadow-glow-teal focus-visible:ring-2 focus-visible:ring-primary/45 border border-primary/20',
        secondary:
        ...
        accent:
          'bg-accent text-accent-foreground shadow-glow-orange hover:bg-accent/95 hover:shadow-glow-orange focus-visible:ring-2 focus-visible:ring-accent/45 border border-accent/20',
        outline:
